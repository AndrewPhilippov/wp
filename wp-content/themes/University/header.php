...
<header class="site-header">
    <div class="container">
        ...
        <a href="<?= esc_url(site_url('/')) ?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search"
        ...
        <div class="site-header__menu group">
            ...
            <div class="site-header__util">
                ...
                <?php } else { ?>
                    <a href="<?= esc_url(site_url('/wp-login.php')) ?>" class="btn btn--small btn--orange float-left push-right">Login</a>
                    <a href="<?= esc_url(site_url('/wp-signup.php')) ?>" class="btn btn--small  btn--dark-orange float-left">Sign Up</a>
                <?php } ?>
                <a href="<?= esc_url(site_url('/')) ?>" class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
</header>
